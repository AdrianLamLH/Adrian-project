...
def StartScreen():
    global startedgame, StartBoxColour, ControlBoxColour, controlscreen
...
def show_controls():
    ...
    # Game title
    drawing("Controls", 28, WHITE, 375, 60)
    # Imports the instructions picture, scaled up to fit the screen
    controls_pic = pygame.image.load('controls.png')
    rescaled_controls_pic = pygame.transform.smoothscale(controls_pic, (940, 500))
    screen.blit(rescaled_controls_pic, (42, 136))
